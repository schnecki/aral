...
gnuplot -e "set key autotitle columnhead; plot for [col=2:3] 'psiValues' using 0:col with points, for [col=4:5] 'psiValues' using 0:col with lines; pause mouse close; " &
...
gnuplot -e "set key autotitle columnhead; plot for [col=2:2] 'reward' using 0:col with lines; pause mouse close; " &
