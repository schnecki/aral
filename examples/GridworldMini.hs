...
-- | BORL Parameters.
params :: Parameters
params = Parameters 0.2 0.2 0.2 0.01 1.0 1.0 0.1 1.5 0.2


-- | Decay function of parameters.
decay :: Decay
decay t _ _ p@(Parameters alp bet del ga eps exp rand zeta xi)
  | t `mod` 200 == 0 = Parameters (f $ slower * alp) (f $ slower * bet) (f $ slower * del) ga (max 0.1 $ slower * eps) (f $ slower * exp) rand zeta xi -- (1 - slower * (1-frc)) mRho
  | otherwise = p
