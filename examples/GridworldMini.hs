...
usermode = do
  ...
  rl <- mkUnichainHasktorchAsSAM (Just (1, 0.05)) [minBound..maxBound] alg (liftInitSt initState) netInp actionFun actFilter params decay modelBuilderHasktorch nnConfig borlSettings (Just initVals)
