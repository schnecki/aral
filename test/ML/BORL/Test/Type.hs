...
--     return $ mkBORLUnichainTabular init as refState params decayFunction

-- instance CoArbitrary (BORL Int) where
--   coarbitrary (BORL a f s t par dec gas rho psis v w r0 r1 vs) = variant 0 . coarbitrary ((a,f), (s, t), (par, dec, gas), (rho, psis, v, w), (r0, r1))
